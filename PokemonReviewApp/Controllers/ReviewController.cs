...
namespace PokemonReviewApp.Controllers
{
    ...
    public class ReviewController : Controller
    {
        ...
        public IActionResult UpdateReview(int reviewId, [FromBody] ReviewDto updatedReviw)
        {
            if (updatedReviw == null)
                return BadRequest(ModelState);

            if (reviewId != updatedReviw.Id)
                return BadRequest(ModelState);
            ...
            var reviewMap = _mapper.Map<Review>(updatedReviw);
