...
namespace PokemonReviewApp.Controllers
{
    ...
    public class ReviewerController:Controller
    {
        ...
        public IActionResult UpdateReviewer(int reviewerId, [FromBody] ReviewerDto updatedReviwer)
        {
            if (updatedReviwer == null)
                return BadRequest(ModelState);

            if (reviewerId != updatedReviwer.Id)
                return BadRequest(ModelState);
            ...
            var reviewerMap = _mapper.Map<Reviewer>(updatedReviwer);
